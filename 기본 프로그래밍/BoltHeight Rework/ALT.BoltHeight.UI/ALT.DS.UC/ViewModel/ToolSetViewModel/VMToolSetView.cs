...
namespace ALT.DS.UC.ViewModel
{
    ...
    public partial class VMToolSetView : GalaSoft.MvvmLight.ViewModelBase
    {
        ...
        private string currentDSCamera;
        ...
        public IEnumerable<string> AvailableDSCameras => Md3DFrameGrabber.FrameGrabbers;
        public string CurrentDSCamera
        {
            get => currentDSCamera;
            set
            {
                if (currentDSCamera != null)
                    Md3DFrameGrabber.Instance.DisconnectCamera();

                
                var serialNumber = value.Split(':').Last();
                Md3DFrameGrabber.Instance.GetAcqFifo(serialNumber);

                Set(ref currentDSCamera, value);
            }
        }
        ...
        public VMToolSetView()
        {
            ...
            RaisePropertyChanged(nameof(AvailableDSCameras));
        }
