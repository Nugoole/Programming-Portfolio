...
namespace ALT.BoltHeight.UI.ViewModel
{
    public partial class VMCameraView : GalaSoft.MvvmLight.ViewModelBase
    {
        ...
        public VMCameraView()
        {
            ...
            connectionCheckThread = new Thread(ConnectionCheckActionAsync);
            encoderCountReadThread = new Thread(EncoderCountReadAction);

            GalaSoft.MvvmLight.Messaging.Messenger.Default.Register<ConfigMessenger>(this, OnCameraConnect);
            GalaSoft.MvvmLight.Messaging.Messenger.Default.Register<AcquiredImageMessenger>(this, OnImageAcquired);
            GalaSoft.MvvmLight.Messaging.Messenger.Default.Register<MainFormClosingMessenger>(this, OnMainFormClosing);
        }
        ...
        private void OnCameraConnect(ConfigMessenger obj)
        {
        ...
        private void OnMainFormClosing(MainFormClosingMessenger obj)
        {
