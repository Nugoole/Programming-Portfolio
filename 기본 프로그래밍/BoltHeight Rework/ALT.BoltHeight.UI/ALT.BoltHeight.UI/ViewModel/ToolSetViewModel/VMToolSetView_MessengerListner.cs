    ...
    public partial class VMToolSetView
    {
        ...
        private void OnRegionNameSetComplete(RegionNameSetCompleteMessenger obj)
        {
            ...
            else
            {
                ...
                {
                    var baseRegion = new CogRectangleAffine() { Interactive = true, GraphicDOFEnable = CogRectangleAffineDOFConstants.All };
                    var targetRegion = new CogRectangleAffine() { Interactive = true, GraphicDOFEnable = CogRectangleAffineDOFConstants.All };
